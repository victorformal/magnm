...
const reviews: Review[] = [
  ...
  },
  {
    ...
    author: "Luc Fontaine",
    rating: 5,
    title: "Panneau + LED = Combinaison parfaite",
    ...
    size: "270x110cm",
    content:
      "J'ai ajouté les bandes LED verticales et c'est magnifique ! L'éclairage chaud met en valeur les panneaux acoustiques. Non seulement l'acoustique s'améliore, mais le design de ma pièce est transformé. Installation facile avec le connecteur rapide.",
    contentFr:
      "J'ai ajouté les bandes LED verticales et c'est magnifique ! L'éclairage chaud met en valeur les panneaux acoustiques. Non seulement l'acoustique s'améliore, mais le design de ma pièce est transformé. Installation facile avec le connecteur rapide.",
    images: [],
    helpfulCount: 56,
  },
  {
    ...
    rating: 5,
    title: "Configuration LED chambre à coucher",
    titleFr: "Configuration LED chambre à coucher",
    date: "Janvier 25, 2026",
    dateFr: "Janvier 25, 2026",
    country: "France",
    verified: true,
    color: "Gris",
    colorFr: "Gris",
    size: "270x110cm",
    content:
      "J'ai installé les panneaux gris avec l'éclairage LED blanc chaud dans ma chambre. L'ambiance est devenue très confortable et l'acoustique a réduit les bruits de la rue. C'est comme avoir un mini-spa à la maison !",
    contentFr:
      "J'ai installé les panneaux gris avec l'éclairage LED blanc chaud dans ma chambre. L'ambiance est devenue très confortable et l'acoustique a réduit les bruits de la rue. C'est comme avoir un mini-spa à la maison !",
    images: [],
    helpfulCount: 48,
  },
  {
    ...
    rating: 5,
    title: "Système d'éclairage professionnel",
    titleFr: "Système d'éclairage professionnel",
    date: "Janvier 22, 2026",
    dateFr: "Janvier 22, 2026",
    country: "France",
    verified: true,
    color: "Noir",
    colorFr: "Noir",
    size: "270x110cm",
    content:
      "J'ai créé un setup home studio avec les panneaux noirs et les LED ajustables. Le contrôle de luminosité est incroyable — du 10 % au 100 %. L'absorption acoustique est excellente et les vidéos que je tourne sur ce mur sont professionnelles.",
    contentFr:
      "J'ai créé un setup home studio avec les panneaux noirs et les LED ajustables. Le contrôle de luminosité est incroyable — du 10 % au 100 %. L'absorption acoustique est excellente et les vidéos que je tourne sur ce mur sont professionnelles.",
    images: [],
    helpfulCount: 62,
  },
  {
    ...
    rating: 5,
    title: "Cuisine moderne avec LED",
    titleFr: "Cuisine moderne avec LED",
    date: "Janvier 19, 2026",
    dateFr: "Janvier 19, 2026",
    country: "France",
    verified: true,
    color: "Chêne Naturel",
    colorFr: "Chêne Naturel",
    size: "270x110cm",
    content:
      "J'ai installé les panneaux avec les bandes LED haute luminosité au-dessus du comptoir de cuisine. L'éclairage révèle vraiment les détails des panneaux en bois. Cela a créé une cuisine très accueillante et fonctionnelle. L'adhésif était très collant !",
    contentFr:
      "J'ai installé les panneaux avec les bandes LED haute luminosité au-dessus du comptoir de cuisine. L'éclairage révèle vraiment les détails des panneaux en bois. Cela a créé une cuisine très accueillante et fonctionnelle. L'adhésif était très collant !",
    images: [],
    helpfulCount: 45,
  },
  {
    ...
    rating: 5,
    title: "Installation facile avec le Quick Connect",
    titleFr: "Installation facile avec le Quick Connect",
    date: "Janvier 16, 2026",
    dateFr: "Janvier 16, 2026",
    country: "France",
    verified: true,
    color: "Chêne Naturel",
    colorFr: "Chêne Naturel",
    size: "270x110cm",
    content:
      "Le système Quick Connect a rendu l'installation des LED tellement simple ! Je pensais que ce serait complexe, mais avec le câble de connexion extra-long et le guide d'installation, c'était un jeu d'enfant. Le résultat final est spectaculaire.",
    contentFr:
      "Le système Quick Connect a rendu l'installation des LED tellement simple ! Je pensais que ce serait complexe, mais avec le câble de connexion extra-long et le guide d'installation, c'était un jeu d'enfant. Le résultat final est spectaculaire.",
    images: [],
    helpfulCount: 51,
  },
  {
    ...
    rating: 5,
    title: "Certification de sécurité et qualité",
    titleFr: "Certification de sécurité et qualité",
    date: "Janvier 13, 2026",
    dateFr: "Janvier 13, 2026",
    country: "France",
    verified: true,
    color: "Noyer",
    colorFr: "Noyer",
    size: "270x110cm",
    content:
      "J'ai été impressionnée par le rapport de test SGS montrant les faibles émissions de formaldéhyde et l'absorption acoustique NRC 0,80. C'est un produit de qualité véritablement certifié. Les panneaux se posent magnifiquement et l'ajout des LED rend tout cela très haut de gamme.",
    contentFr:
      "J'ai été impressionnée par le rapport de test SGS montrant les faibles émissions de formaldéhyde et l'absorption acoustique NRC 0,80. C'est un produit de qualité véritablement certifié. Les panneaux se posent magnifiquement et l'ajout des LED rend tout cela très haut de gamme.",
    images: [],
    helpfulCount: 39,
  },
  {
    ...
    titleFr: "Applications multiples",
    date: "Janvier 10, 2026",
    dateFr: "Janvier 10, 2026",
    country: "France",
    verified: true,
    color: "Gris",
    colorFr: "Gris",
    size: "270x110cm",
    content:
      "J'ai vu les photos d'application dans différentes pièces (bureau, chambre, salon, mur canapé) et cela m'a inspiré. J'ai acheté le kit complet avec les LED et j'ai transformé mon bureau à domicile. Les panneaux s'adaptent parfaitement à chaque espace. Vraiment impressionné !",
    contentFr:
      "J'ai vu les photos d'application dans différentes pièces (bureau, chambre, salon, mur canapé) et cela m'a inspiré. J'ai acheté le kit complet avec les LED et j'ai transformé mon bureau à domicile. Les panneaux s'adaptent parfaitement à chaque espace. Vraiment impressionné !",
    images: [],
    helpfulCount: 44,
